...
export function discoverTypings(
    ...
    packageNameToTypingLocation.forEach((typing, name) => {
        ...
        if (
            inferredTypings.has(name) && inferredTypings.get(name) === undefined && registryEntry !== undefined
            ...
            : host.readDirectory(
                ...
                .filter(manifestPath => {
                    ...
                    return isScoped
                        ...
                        || !isScoped
                            && toFileNameLowerCase(pathComponents[pathComponents.length - 3]) === modulesDirName; // `node_modules/foo`
                });
