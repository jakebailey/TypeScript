...
describe("unittests:: tsserver:: languageService", () => {
    ...
    it("should support multiple projects with the same file under differing `paths` settings", () => {
        ...
        logDiagnostics(
            ...
            projectService.configuredProjects.get(files[1].path)!.getLanguageService().getProgram()!
        ...
        logDiagnostics(
            ...
            projectService.configuredProjects.get(files[4].path)!.getLanguageService().getProgram()!
                .getSemanticDiagnostics(),
        );
        baselineTsserverLogs(
            "languageService",
