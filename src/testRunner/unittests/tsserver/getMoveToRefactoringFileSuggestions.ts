...
import { value1 } from "../node_modules/.cache/someFile.d.ts";`,
    ...
    it("suggests only .js file for a .js filepath", () => {
        ...
        const tsconfig: File = {
            path: "/tsconfig.json",
            content: JSON.stringify({ files: ["./file1.js", "./file2.js", "./file3.mts", "./file4.ts", "./file5.js"] }),
        };
    ...
    it("skips lib.d.ts files", () => {
        ...
        const tsconfig: File = {
            path: "/tsconfig.json",
            content: JSON.stringify({ files: ["./file1.d.ts", "./a/lib.d.ts", "./a/file3.d.ts", "/a/lib.es6.d.ts"] }),
        };
