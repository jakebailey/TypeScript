...
function classifySymbol(
    ...
    if ((flags & SymbolFlags.Classifiable) === SymbolFlags.None) {
        ...
        return meaningAtPosition & SemanticMeaning.Namespace
            ...
            ? ClassificationType.moduleName : undefined;
    }
                ...
                switch (tag.kind) {
                    ...
                    case SyntaxKind.JSDocTypedefTag:
                        ...
                        commentStart =
                            ...
                            || type.typeExpression?.end || commentStart;
                        break;
    ...
    function classifyTokenType(tokenKind: SyntaxKind, token?: Node): ClassificationType | undefined {
        ...
        if (isPunctuation(tokenKind)) {
            ...
            return token && token.parent.kind === SyntaxKind.JsxAttribute
                ? ClassificationType.jsxAttributeStringLiteralValue : ClassificationType.stringLiteral;
        }
