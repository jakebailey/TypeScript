...
export function getAllRules(): RuleSpec[] {
    ...
    const highPriorityCommonRules = [
        ...
        rule("NotSpaceBeforeColon", anyToken, SyntaxKind.ColonToken, [
            isNonJsxSameLineTokenContext,
            isNotBinaryOpContext,
            isNotTypeAnnotationContext,
        ], RuleAction.DeleteSpace),
        rule("SpaceAfterColon", SyntaxKind.ColonToken, anyToken, [
            isNonJsxSameLineTokenContext,
            isNotBinaryOpContext,
            isNextTokenParentNotJsxNamespacedName,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBeforeQuestionMark", anyToken, SyntaxKind.QuestionToken, [
            isNonJsxSameLineTokenContext,
            isNotBinaryOpContext,
            isNotTypeAnnotationContext,
        ], RuleAction.DeleteSpace),
        // insert space after '?' only when it is used in conditional operator
        rule("SpaceAfterQuestionMarkInConditionalOperator", SyntaxKind.QuestionToken, anyToken, [
            isNonJsxSameLineTokenContext,
        ...
        rule("NoSpaceBeforeDot", anyToken, [SyntaxKind.DotToken, SyntaxKind.QuestionDotToken], [
            isNonJsxSameLineTokenContext,
            isNotPropertyAccessOnIntegerLiteral,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterDot", [SyntaxKind.DotToken, SyntaxKind.QuestionDotToken], anyToken, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),

        rule("NoSpaceBetweenImportParenInImportType", SyntaxKind.ImportKeyword, SyntaxKind.OpenParenToken, [
            isNonJsxSameLineTokenContext,
            isImportTypeContext,
        ], RuleAction.DeleteSpace),
        ...
        rule("NoSpaceAfterUnaryPreincrementOperator", SyntaxKind.PlusPlusToken, unaryPreincrementExpressions, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterUnaryPredecrementOperator", SyntaxKind.MinusMinusToken, unaryPredecrementExpressions, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBeforeUnaryPostincrementOperator", unaryPostincrementExpressions, SyntaxKind.PlusPlusToken, [
            isNonJsxSameLineTokenContext,
            isNotStatementConditionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBeforeUnaryPostdecrementOperator", unaryPostdecrementExpressions, SyntaxKind.MinusMinusToken, [
            isNonJsxSameLineTokenContext,
            isNotStatementConditionContext,
        ], RuleAction.DeleteSpace),
        ...
        //      1 - -2  --X--> 1--2
        //      a + ++b --X--> a+++b
        rule("SpaceAfterPostincrementWhenFollowedByAdd", SyntaxKind.PlusPlusToken, SyntaxKind.PlusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),
        rule("SpaceAfterAddWhenFollowedByUnaryPlus", SyntaxKind.PlusToken, SyntaxKind.PlusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),
        rule("SpaceAfterAddWhenFollowedByPreincrement", SyntaxKind.PlusToken, SyntaxKind.PlusPlusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),
        rule("SpaceAfterPostdecrementWhenFollowedBySubtract", SyntaxKind.MinusMinusToken, SyntaxKind.MinusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),
        rule("SpaceAfterSubtractWhenFollowedByUnaryMinus", SyntaxKind.MinusToken, SyntaxKind.MinusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),
        rule("SpaceAfterSubtractWhenFollowedByPredecrement", SyntaxKind.MinusToken, SyntaxKind.MinusMinusToken, [
            isNonJsxSameLineTokenContext,
            isBinaryOpContext,
        ], RuleAction.InsertSpace),

        rule("NoSpaceAfterCloseBrace", SyntaxKind.CloseBraceToken, [SyntaxKind.CommaToken, SyntaxKind.SemicolonToken], [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        // For functions and control block place } on a new line [multi-line rule]
        rule("NewLineBeforeCloseBraceInBlockContext", anyTokenIncludingMultilineComments, SyntaxKind.CloseBraceToken, [
            isMultilineBlockContext,
        ], RuleAction.InsertNewLine),

        // Space/new line after }.
        rule("SpaceAfterCloseBrace", SyntaxKind.CloseBraceToken, anyTokenExcept(SyntaxKind.CloseParenToken), [
            isNonJsxSameLineTokenContext,
            isAfterCodeBlockContext,
        ], RuleAction.InsertSpace),
        // Special case for (}, else) and (}, while) since else & while tokens are not part of the tree which makes SpaceAfterCloseBrace rule not applied
        // Also should not apply to })
        rule("SpaceBetweenCloseBraceAndElse", SyntaxKind.CloseBraceToken, SyntaxKind.ElseKeyword, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBetweenCloseBraceAndWhile", SyntaxKind.CloseBraceToken, SyntaxKind.WhileKeyword, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        ...
        rule("SpaceAfterConditionalClosingParen", SyntaxKind.CloseParenToken, SyntaxKind.OpenBracketToken, [
            isControlDeclContext,
        ], RuleAction.InsertSpace),

        rule("NoSpaceBetweenFunctionKeywordAndStar", SyntaxKind.FunctionKeyword, SyntaxKind.AsteriskToken, [
            isFunctionDeclarationOrFunctionExpressionContext,
        ], RuleAction.DeleteSpace),
        rule("SpaceAfterStarInGeneratorDeclaration", SyntaxKind.AsteriskToken, SyntaxKind.Identifier, [
            isFunctionDeclarationOrFunctionExpressionContext,
        ], RuleAction.InsertSpace),
        ...
        //      get x() {}
        //      set x(val) {}
        rule("SpaceAfterGetSetInMember", [SyntaxKind.GetKeyword, SyntaxKind.SetKeyword], SyntaxKind.Identifier, [
            isFunctionDeclContext,
        ], RuleAction.InsertSpace),

        rule("NoSpaceBetweenYieldKeywordAndStar", SyntaxKind.YieldKeyword, SyntaxKind.AsteriskToken, [
            isNonJsxSameLineTokenContext,
            isYieldOrYieldStarWithOperand,
        ], RuleAction.DeleteSpace),
        rule("SpaceBetweenYieldOrYieldStarAndOperand", [SyntaxKind.YieldKeyword, SyntaxKind.AsteriskToken], anyToken, [
            isNonJsxSameLineTokenContext,
            isYieldOrYieldStarWithOperand,
        ], RuleAction.InsertSpace),

        rule("NoSpaceBetweenReturnAndSemicolon", SyntaxKind.ReturnKeyword, SyntaxKind.SemicolonToken, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule(
        ...
        rule("SpaceAfterLetConstInVariableDeclaration", [SyntaxKind.LetKeyword, SyntaxKind.ConstKeyword], anyToken, [
            isNonJsxSameLineTokenContext,
            isStartOfVariableDeclarationList,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBeforeOpenParenInFuncCall", anyToken, SyntaxKind.OpenParenToken, [
            isNonJsxSameLineTokenContext,
        ...
        rule("SpaceAfterVoidOperator", SyntaxKind.VoidKeyword, anyToken, [
            isNonJsxSameLineTokenContext,
            isVoidOpContext,
        ], RuleAction.InsertSpace),

        // Async-await
        rule("SpaceBetweenAsyncAndOpenParen", SyntaxKind.AsyncKeyword, SyntaxKind.OpenParenToken, [
        ...
        rule("SpaceBeforeJsxAttribute", anyToken, SyntaxKind.Identifier, [
            isNextTokenParentJsxAttribute,
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBeforeSlashInJsxOpeningElement", anyToken, SyntaxKind.SlashToken, [
            isJsxSelfClosingElementContext,
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBeforeGreaterThanTokenInJsxOpeningElement", SyntaxKind.SlashToken, SyntaxKind.GreaterThanToken, [
            isJsxSelfClosingElementContext,
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        ...
        rule("NoSpaceAfterEqualInJsxAttribute", SyntaxKind.EqualsToken, anyToken, [
            isJsxAttributeContext,
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBeforeJsxNamespaceColon", SyntaxKind.Identifier, SyntaxKind.ColonToken, [
            isNextTokenParentJsxNamespacedName,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterJsxNamespaceColon", SyntaxKind.ColonToken, SyntaxKind.Identifier, [
            isNextTokenParentJsxNamespacedName,
        ], RuleAction.DeleteSpace),
        ...
        rule("NoSpaceBeforeOpenAngularBracket", typeNames, SyntaxKind.LessThanToken, [
            isNonJsxSameLineTokenContext,
            isTypeArgumentOrParameterOrAssertionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBetweenCloseParenAndAngularBracket", SyntaxKind.CloseParenToken, SyntaxKind.LessThanToken, [
            isNonJsxSameLineTokenContext,
            isTypeArgumentOrParameterOrAssertionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterOpenAngularBracket", SyntaxKind.LessThanToken, anyToken, [
            isNonJsxSameLineTokenContext,
            isTypeArgumentOrParameterOrAssertionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBeforeCloseAngularBracket", anyToken, SyntaxKind.GreaterThanToken, [
            isNonJsxSameLineTokenContext,
            isTypeArgumentOrParameterOrAssertionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterCloseAngularBracket", SyntaxKind.GreaterThanToken, [
            SyntaxKind.OpenParenToken,
            SyntaxKind.OpenBracketToken,
        ...
        // decorators
        rule("SpaceBeforeAt", [SyntaxKind.CloseParenToken, SyntaxKind.Identifier], SyntaxKind.AtToken, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        ...
        rule("NoSpaceBeforeNonNullAssertionOperator", anyToken, SyntaxKind.ExclamationToken, [
            isNonJsxSameLineTokenContext,
            isNonNullAssertionContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterNewKeywordOnConstructorSignature", SyntaxKind.NewKeyword, SyntaxKind.OpenParenToken, [
            isNonJsxSameLineTokenContext,
            isConstructorSignatureContext,
        ], RuleAction.DeleteSpace),
        rule("SpaceLessThanAndNonJSXTypeAnnotation", SyntaxKind.LessThanToken, SyntaxKind.LessThanToken, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
    ];
    ...
    const userConfigurableRules = [
        ...
        rule("SpaceAfterConstructor", SyntaxKind.ConstructorKeyword, SyntaxKind.OpenParenToken, [
            isOptionEnabled("insertSpaceAfterConstructor"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceAfterConstructor", SyntaxKind.ConstructorKeyword, SyntaxKind.OpenParenToken, [
            isOptionDisabledOrUndefined("insertSpaceAfterConstructor"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),

        rule("SpaceAfterComma", SyntaxKind.CommaToken, anyToken, [
        ...
        rule("NoSpaceAfterComma", SyntaxKind.CommaToken, anyToken, [
        ...
        rule(
            ...
            [SyntaxKind.FunctionKeyword, SyntaxKind.AsteriskToken],
            SyntaxKind.OpenParenToken,
        ...
        rule("SpaceAfterKeywordInControl", keywords, SyntaxKind.OpenParenToken, [
            isOptionEnabled("insertSpaceAfterKeywordsInControlFlowStatements"),
            isControlDeclContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceAfterKeywordInControl", keywords, SyntaxKind.OpenParenToken, [
            isOptionDisabledOrUndefined("insertSpaceAfterKeywordsInControlFlowStatements"),
            isControlDeclContext,
        ], RuleAction.DeleteSpace),

        // Insert space after opening and before closing nonempty parenthesis
        rule("SpaceAfterOpenParen", SyntaxKind.OpenParenToken, anyToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBeforeCloseParen", anyToken, SyntaxKind.CloseParenToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBetweenOpenParens", SyntaxKind.OpenParenToken, SyntaxKind.OpenParenToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBetweenParens", SyntaxKind.OpenParenToken, SyntaxKind.CloseParenToken, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceAfterOpenParen", SyntaxKind.OpenParenToken, anyToken, [
            isOptionDisabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),
        rule("NoSpaceBeforeCloseParen", anyToken, SyntaxKind.CloseParenToken, [
            isOptionDisabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),

        // Insert space after opening and before closing nonempty brackets
        rule("SpaceAfterOpenBracket", SyntaxKind.OpenBracketToken, anyToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBeforeCloseBracket", anyToken, SyntaxKind.CloseBracketToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
        ...
        rule("NoSpaceAfterOpenBracket", SyntaxKind.OpenBracketToken, anyToken, [
        ...
        rule("SpaceAfterOpenBrace", SyntaxKind.OpenBraceToken, anyToken, [
            isOptionEnabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces"),
            isBraceWrappedContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBeforeCloseBrace", anyToken, SyntaxKind.CloseBraceToken, [
            isOptionEnabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces"),
            isBraceWrappedContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBetweenEmptyBraceBrackets", SyntaxKind.OpenBraceToken, SyntaxKind.CloseBraceToken, [
        ...
        rule("NoSpaceAfterOpenBrace", SyntaxKind.OpenBraceToken, anyToken, [
        ...
        rule("SpaceBetweenEmptyBraceBrackets", SyntaxKind.OpenBraceToken, SyntaxKind.CloseBraceToken, [
        ...
        rule("SpaceBeforeTemplateMiddleAndTail", anyToken, [SyntaxKind.TemplateMiddle, SyntaxKind.TemplateTail], [
        ...
        rule("NoSpaceBeforeTemplateMiddleAndTail", anyToken, [SyntaxKind.TemplateMiddle, SyntaxKind.TemplateTail], [
            isOptionDisabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces"),
            isNonJsxSameLineTokenContext,
        ], RuleAction.DeleteSpace),

        // No space after { and before } in JSX expression
        rule("SpaceAfterOpenBraceInJsxExpression", SyntaxKind.OpenBraceToken, anyToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingJsxExpressionBraces"),
            isNonJsxSameLineTokenContext,
            isJsxExpressionContext,
        ], RuleAction.InsertSpace),
        rule("SpaceBeforeCloseBraceInJsxExpression", anyToken, SyntaxKind.CloseBraceToken, [
            isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingJsxExpressionBraces"),
            isNonJsxSameLineTokenContext,
            isJsxExpressionContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceAfterOpenBraceInJsxExpression", SyntaxKind.OpenBraceToken, anyToken, [
        ...
        rule("SpaceAfterSemicolonInFor", SyntaxKind.SemicolonToken, anyToken, [
            isOptionEnabled("insertSpaceAfterSemicolonInForStatements"),
            isNonJsxSameLineTokenContext,
            isForContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceAfterSemicolonInFor", SyntaxKind.SemicolonToken, anyToken, [
        ...
        rule("SpaceBeforeOpenParenInFuncDecl", anyToken, SyntaxKind.OpenParenToken, [
            isOptionEnabled("insertSpaceBeforeFunctionParenthesis"),
            isNonJsxSameLineTokenContext,
            isFunctionDeclContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBeforeOpenParenInFuncDecl", anyToken, SyntaxKind.OpenParenToken, [
        ...
        rule("SpaceAfterTypeAssertion", SyntaxKind.GreaterThanToken, anyToken, [
            isOptionEnabled("insertSpaceAfterTypeAssertion"),
            isNonJsxSameLineTokenContext,
            isTypeAssertionContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceAfterTypeAssertion", SyntaxKind.GreaterThanToken, anyToken, [
            isOptionDisabledOrUndefined("insertSpaceAfterTypeAssertion"),
            isNonJsxSameLineTokenContext,
            isTypeAssertionContext,
        ], RuleAction.DeleteSpace),

        rule("SpaceBeforeTypeAnnotation", anyToken, [SyntaxKind.QuestionToken, SyntaxKind.ColonToken], [
            isOptionEnabled("insertSpaceBeforeTypeAnnotation"),
            isNonJsxSameLineTokenContext,
            isTypeAnnotationContext,
        ], RuleAction.InsertSpace),
        rule("NoSpaceBeforeTypeAnnotation", anyToken, [SyntaxKind.QuestionToken, SyntaxKind.ColonToken], [
            isOptionDisabledOrUndefined("insertSpaceBeforeTypeAnnotation"),
            isNonJsxSameLineTokenContext,
            isTypeAnnotationContext,
        ], RuleAction.DeleteSpace),

        rule("NoOptionalSemicolon", SyntaxKind.SemicolonToken, anyTokenIncludingEOF, [
    ...
    const lowPriorityCommonRules = [
        ...
        rule("NoSpaceAfterCloseBracket", SyntaxKind.CloseBracketToken, anyToken, [
            isNonJsxSameLineTokenContext,
        ...
        rule("SpaceBetweenForAndAwaitKeyword", SyntaxKind.ForKeyword, SyntaxKind.AwaitKeyword, [
            isNonJsxSameLineTokenContext,
        ], RuleAction.InsertSpace),
...
function rule(
    ...
    return {
        ...
        rule: { debugName, context, action, flags },
    };
}
...
function isOptionDisabledOrUndefinedOrTokensOnSameLine(
    ...
    return context =>
        !context.options || !hasProperty(context.options, optionName) || !context.options[optionName]
...
function isFunctionDeclarationOrFunctionExpressionContext(context: FormattingContext): boolean {
    return context.contextNode.kind === SyntaxKind.FunctionDeclaration
...
function isAfterCodeBlockContext(context: FormattingContext): boolean {
    switch (context.currentTokenParent.kind) {
        ...
        case SyntaxKind.Block: {
            ...
            if (
                !blockParent
                || blockParent.kind !== SyntaxKind.ArrowFunction && blockParent.kind !== SyntaxKind.FunctionExpression
            ) {
                return true;
            }
        }
...
function isNextTokenParentJsxAttribute(context: FormattingContext): boolean {
    return context.nextTokenParent.kind === SyntaxKind.JsxAttribute || (
        context.nextTokenParent.kind === SyntaxKind.JsxNamespacedName
        && context.nextTokenParent.parent.kind === SyntaxKind.JsxAttribute
    );
}
...
function isVoidOpContext(context: FormattingContext): boolean {
    return context.currentTokenSpan.kind === SyntaxKind.VoidKeyword
...
function isYieldOrYieldStarWithOperand(context: FormattingContext): boolean {
    return context.contextNode.kind === SyntaxKind.YieldExpression
