...
registerCodeFix({
    ...
    getCodeActions: function getCodeActionsToAddMissingAsync(context) {
        ...
        const directSpan = diagnostic?.relatedInformation && find(diagnostic.relatedInformation, r => r.code === Diagnostics.Did_you_mean_to_mark_this_function_as_async.code) as TextSpan | undefined;
