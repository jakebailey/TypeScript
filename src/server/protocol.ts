...
/** @internal */
export interface CommandToRequest {
    [CommandTypes.JsxClosingTag]: never;
    [CommandTypes.Brace]: never;
    [CommandTypes.BraceFull]: never;
    [CommandTypes.BraceCompletion]: never;
    [CommandTypes.GetSpanOfEnclosingComment]: never;
    [CommandTypes.Change]: never;
    [CommandTypes.Close]: never;
    [CommandTypes.Completions]: never;
    [CommandTypes.CompletionInfo]: never;
    [CommandTypes.CompletionsFull]: never;
    [CommandTypes.CompletionDetails]: never;
    [CommandTypes.CompletionDetailsFull]: never;
    [CommandTypes.CompileOnSaveAffectedFileList]: never;
    [CommandTypes.CompileOnSaveEmitFile]: never;
    [CommandTypes.Configure]: never;
    [CommandTypes.Definition]: (request: DefinitionRequest) => Readonly<DefinitionResponse["body"]>;
    [CommandTypes.DefinitionFull]: never;
    [CommandTypes.DefinitionAndBoundSpan]: never;
    [CommandTypes.DefinitionAndBoundSpanFull]: never;
    [CommandTypes.Implementation]: never;
    [CommandTypes.ImplementationFull]: never;
    [CommandTypes.EmitOutput]: never;
    [CommandTypes.Exit]: () => void;
    [CommandTypes.FileReferences]: never;
    [CommandTypes.FileReferencesFull]: never;
    [CommandTypes.Format]: never;
    [CommandTypes.Formatonkey]: never;
    [CommandTypes.FormatFull]: never;
    [CommandTypes.FormatonkeyFull]: never;
    [CommandTypes.FormatRangeFull]: never;
    [CommandTypes.Geterr]: never;
    [CommandTypes.GeterrForProject]: never;
    [CommandTypes.SemanticDiagnosticsSync]: never;
    [CommandTypes.SyntacticDiagnosticsSync]: never;
    [CommandTypes.SuggestionDiagnosticsSync]: never;
    [CommandTypes.NavBar]: never;
    [CommandTypes.NavBarFull]: never;
    [CommandTypes.Navto]: never;
    [CommandTypes.NavtoFull]: never;
    [CommandTypes.NavTree]: never;
    [CommandTypes.NavTreeFull]: never;
    [CommandTypes.Occurrences]: never;
    [CommandTypes.DocumentHighlights]: never;
    [CommandTypes.DocumentHighlightsFull]: never;
    [CommandTypes.Open]: never;
    [CommandTypes.Quickinfo]: never;
    [CommandTypes.QuickinfoFull]: never;
    [CommandTypes.References]: never;
    [CommandTypes.ReferencesFull]: never;
    [CommandTypes.Reload]: never;
    [CommandTypes.Rename]: never;
    [CommandTypes.RenameInfoFull]: never;
    [CommandTypes.RenameLocationsFull]: never;
    [CommandTypes.Saveto]: never;
    [CommandTypes.SignatureHelp]: never;
    [CommandTypes.SignatureHelpFull]: never;
    [CommandTypes.FindSourceDefinition]: never;
    [CommandTypes.Status]: () => StatusResponseBody;
    [CommandTypes.TypeDefinition]: never;
    [CommandTypes.ProjectInfo]: never;
    [CommandTypes.ReloadProjects]: never;
    [CommandTypes.Unknown]: never;
    [CommandTypes.OpenExternalProject]: (request: OpenExternalProjectRequest) => true;
    [CommandTypes.OpenExternalProjects]: (request: OpenExternalProjectsRequest) => true;
    [CommandTypes.CloseExternalProject]: (request: CloseExternalProjectRequest) => true;
    [CommandTypes.SynchronizeProjectList]: (request: SynchronizeProjectListRequest) => {}; // TODO(jakebailey): what is this?
    [CommandTypes.ApplyChangedToOpenFiles]: (request: ApplyChangedToOpenFilesRequest) => true;
    [CommandTypes.UpdateOpen]: (request: UpdateOpenRequest) => true;
    [CommandTypes.EncodedSyntacticClassificationsFull]: never;
    [CommandTypes.EncodedSemanticClassificationsFull]: never;
    [CommandTypes.Cleanup]: never;
    [CommandTypes.GetOutliningSpans]: never;
    [CommandTypes.GetOutliningSpansFull]: never;
    [CommandTypes.TodoComments]: never;
    [CommandTypes.Indentation]: never;
    [CommandTypes.DocCommentTemplate]: never;
    [CommandTypes.CompilerOptionsDiagnosticsFull]: never;
    [CommandTypes.NameOrDottedNameSpan]: never;
    [CommandTypes.BreakpointStatement]: never;
    [CommandTypes.CompilerOptionsForInferredProjects]: never;
    [CommandTypes.GetCodeFixes]: never;
    [CommandTypes.GetCodeFixesFull]: never;
    [CommandTypes.GetCombinedCodeFix]: never;
    [CommandTypes.GetCombinedCodeFixFull]: never;
    [CommandTypes.ApplyCodeActionCommand]: never;
    [CommandTypes.GetSupportedCodeFixes]: never;
    [CommandTypes.GetApplicableRefactors]: never;
    [CommandTypes.GetEditsForRefactor]: never;
    [CommandTypes.GetEditsForRefactorFull]: never;
    [CommandTypes.OrganizeImports]: never;
    [CommandTypes.OrganizeImportsFull]: never;
    [CommandTypes.GetEditsForFileRename]: never;
    [CommandTypes.GetEditsForFileRenameFull]: never;
    [CommandTypes.ConfigurePlugin]: never;
    [CommandTypes.SelectionRange]: never;
    [CommandTypes.SelectionRangeFull]: never;
    [CommandTypes.ToggleLineComment]: never;
    [CommandTypes.ToggleLineCommentFull]: never;
    [CommandTypes.ToggleMultilineComment]: never;
    [CommandTypes.ToggleMultilineCommentFull]: never;
    [CommandTypes.CommentSelection]: never;
    [CommandTypes.CommentSelectionFull]: never;
    [CommandTypes.UncommentSelection]: never;
    [CommandTypes.UncommentSelectionFull]: never;
    [CommandTypes.PrepareCallHierarchy]: never;
    [CommandTypes.ProvideCallHierarchyIncomingCalls]: never;
    [CommandTypes.ProvideCallHierarchyOutgoingCalls]: never;
    [CommandTypes.ProvideInlayHints]: never;
}
