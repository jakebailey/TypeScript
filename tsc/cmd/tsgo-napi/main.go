...
import (
	...
	"github.com/microsoft/TypeScript/tsc/internal/napi"
	"github.com/microsoft/TypeScript/tsc/internal/project"
	"github.com/microsoft/TypeScript/tsc/internal/tsgorun"
...
func (fs *napiCallbackFS) AppendFile(path string, data string) error {
