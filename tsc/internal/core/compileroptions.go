...
//go:generate go -C ../../../tools tool stringer -dir=../tsc/internal/core -type=ModuleKind -trimprefix=ModuleKind -output=modulekind_stringer_generated.go
//go:generate go -C ../../../tools tool stringer -dir=../tsc/internal/core -type=ScriptTarget -trimprefix=ScriptTarget -output=scripttarget_stringer_generated.go
