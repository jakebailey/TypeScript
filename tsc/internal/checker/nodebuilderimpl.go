...
func (b *NodeBuilderImpl) shouldWriteTypeOfFunctionSymbol(symbol *ast.Symbol, t *Type) (bool, *ast.Symbol) {
...
func (b *NodeBuilderImpl) shouldEmitTypeOfSymbol(forceExpansion bool, forceClassExpansion bool, isInstanceType ast.SymbolFlags, symbol *ast.Symbol, t *Type) (bool, *ast.Symbol) {
	if forceExpansion {
		return false, symbol
	}
	...
	return b.shouldWriteTypeOfFunctionSymbol(symbol, t)
}
...
func (b *NodeBuilderImpl) createAnonymousTypeNodeEx(t *Type, forceClassExpansion bool, forceExpansion bool) *ast.TypeNode {
	...
	if symbol != nil {
		...
		// } else
		if ok, symbol := b.shouldEmitTypeOfSymbol(forceExpansion, forceClassExpansion, isInstanceType, symbol, t); ok {
