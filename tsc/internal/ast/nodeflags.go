...
//go:generate go -C ../../../tools tool stringer -dir=../tsc/internal/ast -type=NodeFlags,ModifierFlags,SymbolFlags,CheckFlags,TokenFlags -bitflag -output=bitflags_stringer_generated.go
