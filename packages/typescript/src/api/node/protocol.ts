...
export const HEADER_OFFSET_STRING_TABLE_OFFSETS = 20;
export const HEADER_OFFSET_STRING_TABLE = 24;
export const HEADER_OFFSET_EXTENDED_DATA = 28;
export const HEADER_OFFSET_STRUCTURED_DATA = 32;
