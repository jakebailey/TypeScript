...
describe("Source file cache keying across projects", () => {
    ...
    test("different module detection modes share cached source files", async () => {
        ...
        try {
            ...
            assert.strictEqual(sfA, sfC, "projectA and projectC should share the same cached source file");
        }
        finally {
            await api.close();
        }
